...
$seleccionar = "SELECT * FROM examenes ORDER BY id_examen DESC";
...
<table width="777" border="0" align="left">
  <tr>
    ...
    <td width="438" class="tex2"><?php echo $arreglo['examen']; ?></td>
    <td width="128" class="tex2"><div align="center"><?php echo $arreglo['fecha_ingreso']; ?></div></td>
