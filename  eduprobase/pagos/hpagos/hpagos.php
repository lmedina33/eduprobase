...
<td width="850" bgcolor="#FFFFFF">
	<?php include('../menu2.php'); ?>
		...
		<div class="title"> Consultas de Pagos </div>
        <br />
		...
		$carne = $_GET['carne'];
		$anio = date('Y');
		$seleccionar = "SELECT * FROM tpagos t, fpagos f WHERE t.carne = '$carne' AND t.id_fpagos = f.id_fpagos";
		$ejecutar = mysql_query($seleccionar);
		
		while($arreglo = mysql_fetch_assoc($ejecutar)){
		?>
		<td class="text4blue"> <?php echo $arreglo['nombre_fpagos'];?></td>
		<td class="text4blue"> Q.<?php echo $arreglo['precio_fpagos'];?> quet.</td>
