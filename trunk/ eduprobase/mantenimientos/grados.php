        ...
        <tr>
          ...
          <td width="809"><div align="right">
              ...
              <table width="821" align="center">
                <tr>
                  <td width="806" bgcolor="#4682B4"><div class="title"> Mantenimiento de Grado </div></td>
                </tr>
                <tr bgcolor="#F3F3F3">
                  <td bordercolor="#000000" bgcolor="#F3F3F3"><br />
                      <table width="812" border="0">
                        <tr>
                          <td width="71">&nbsp;</td>
                          <td width="38">&nbsp;</td>
                          <td width="441"><div align="center" class="Estilo6">Nombre del Grado </div></td>
                          <td width="150">&nbsp;</td>
                    ...
                    <br />
                      <table width="812" border="0">
                        <tr>
                          ...
                          <td width="38"></td>
                          <td width="441">
                              <div align="left" class="text1"><a href="mod_grados.php?id_grado=<?php echo $arreglo['id_grado']; ?>"><?php echo $arreglo['nombre']; ?></a>
                          </div></td>
                          <td width="150">&nbsp;</td>
                          <td width="90" class="Estilo11"><div align="center" class="text1"><a href="mod_grados.php?id_grado=<?php echo $arreglo['id_grado']; ?>"><img src="../images/iconos/104.ico" border="0" /></a></a></div></td>
                        </tr>
                      </table>
                    <?php }?>
                    <br />
